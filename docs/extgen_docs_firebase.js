 ...
 * @param {String} name
 * @param {Array[Struct.FirebaseAnalyticsParameter]} params
 * @function_end
 */
 ...
 * @param {Enum.FirebaseAppCheckProvider} provider
 * @function_end
 */
 ...
 * @param {Enum.FirebaseLogLevel} level
 * @function_end
 */
 ...
 * @param {Real} ref
 * @param {Enum.FirestoreSource} source
 * @param {Function} [callback]
 * @returns {Enum.FirebaseError}
 * @function_end
 */
 ...
 * @param {Real} ref
 * @param {String} field
 * @param {Enum.FirestoreDirection} direction
 * @returns {Real}
 * @function_end
 */
 ...
 * @param {Real} ref
 * @param {String} field
 * @param {Enum.FirestoreServerTimestampBehavior} server_timestamp_behavior
...
/**
 * @function_partial firebase_functions_callable_release
 * @param {Real} ref
 * @function_end
 */
 ...
 * @param {Real} aggregate_query
 * @param {Enum.FirestoreAggregateSource} source
 * @param {Function} [callback]
 * @returns {Enum.FirebaseError}
 * @function_end
 */
 ...
 * @param {Struct.FirebaseAppOptions} options
 * @param {String} name
 * @returns {Real}
 * @function_end
 */
...
/**
 * @struct_partial FirebaseAnalyticsParameter
 * @member {String} name
 * @member {Any} value
 * @struct_end
 */
...
/**
 * @struct_partial FirebaseAppCheckToken
 * @member {String} token
 * @member {Real} expire_time_millis
 * @struct_end
 */

/**
 * @struct_partial FirebaseAuthProviderUserInfo
 * @member {String} uid
 * @member {String} email
...
/**
 * @struct_partial FirebaseAuthAdditionalUserInfo
 * @member {String} provider_id
 * @member {String} user_name
 * @member {Any} profile
 * @member {Real} [updated_credential]
 * @struct_end
 */
...
/**
 * @struct_partial FirestoreTimestamp
 * @member {Real} seconds
 * @member {Real} nanoseconds
 * @struct_end
 */
...
/**
 * @struct_partial FirestoreDocumentChange
 * @member {Enum.FirestoreDocumentChangeType} type
 * @member {Real} document
 * @member {Real} old_index
 * @member {Real} new_index
 * @struct_end
 */

/**
 * @struct_partial FirestoreFieldLookup
 * @member {Bool} exists
 * @member {Any} value
 * @struct_end
 */
...
/**
 * @struct_partial FirestoreFieldPathValue
 * @member {Real} field_path
 * @member {Any} value
 * @struct_end
 */

/**
 * @struct_partial FirestoreLoadBundleTaskProgress
 * @member {Real} documents_loaded
 * @member {Real} total_documents
 * @member {Real} bytes_loaded
 * @member {Real} total_bytes
 * @member {Enum.FirestoreLoadBundleTaskState} state
 * @struct_end
 */
 ...
 * @member {Enum.FirebaseRemoteConfigLastFetchStatus} last_fetch_status
 * @member {Enum.FirebaseRemoteConfigFetchFailureReason} last_fetch_failure_reason
 * @member {Real} throttled_end_time
 * @struct_end
 */

/**
 * @struct_partial FirebaseRemoteConfigBooleanInfo
 * @member {Bool} value
 * @member {Enum.FirebaseRemoteConfigValueSource} source
 * @member {Bool} conversion_successful
 * @struct_end
 */

/**
 * @struct_partial FirebaseRemoteConfigLongInfo
 * @member {Real} value
 * @member {Enum.FirebaseRemoteConfigValueSource} source
 * @member {Bool} conversion_successful
 * @struct_end
...
/**
 * @struct_partial FirebaseRemoteConfigDoubleInfo
 * @member {Real} value
 * @member {Enum.FirebaseRemoteConfigValueSource} source
 * @member {Bool} conversion_successful
 * @struct_end
...
/**
 * @struct_partial FirebaseRemoteConfigStringInfo
 * @member {String} value
 * @member {Enum.FirebaseRemoteConfigValueSource} source
 * @member {Bool} conversion_successful
 * @struct_end
...
/**
 * @struct_partial FirebaseRemoteConfigDataInfo
 ...
 * @member {String} [messaging_sender_id]
 * @member {String} [database_url]
 * @member {String} [ga_tracking_id]
...
/**
 * @struct_partial FirebaseAuthResult
 * @member {Real} [user]
 ...
 * @member InvalidEventHandler
 * @member FederatedProviderAreadyInUse
 * @member InvalidAuthenticatedUserData
 * @member FederatedSignInUserInteractionFailure
 * @member MissingOrInvalidNonce
 * @member UserCancelled
 * @member UnsupportedPassthroughOperation
 * @member TokenRefreshUnavailable
 * @enum_end
 */
...
/**
 * @enum_partial FirestoreLoadBundleTaskState
 * @member Error
 * @member InProgress
 * @member Success
 * @enum_end
...
/**
 * @enum_partial FirebaseRemoteConfigValueSource
 * @member StaticValue
 * @member RemoteValue
 * @member DefaultValue
 * @enum_end
...
/**
 * @enum_partial FirebaseRemoteConfigError
 * @member Unimplemented
 * @member None
 * @member ConfigUpdateStreamError
 * @member ConfigUpdateMessageInvalid
 * @member ConfigUpdateNotFetched
 * @member ConfigUpdateUnavailable
 * @enum_end
 */
...
/**
 * @enum_partial FirestoreAggregateSource
 * @member Server
 * @enum_end
 */
