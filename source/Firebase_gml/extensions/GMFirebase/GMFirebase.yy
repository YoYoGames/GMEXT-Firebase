{
  ...
  "options": [
    ...
    },
    {
      ...
      "description": "Root of the unpacked Firebase C\u002B\u002B SDK 13.13.0 (firebase_cpp_sdk_13.13.0.zip from https://dl.google.com/firebase/sdk/cpp/), one root for every target. Android reads the messaging AAR from libs/android (the SDK proguard rules are built into the extension), iOS stages xcframeworks/ from it, Windows copies libs/windows/google_analytics.dll from it beside the executable when the file is present (Analytics is the SDK\u0027s stub without it - see the README). macOS and Linux link the SDK statically and stage nothing.",
    ...
    },
    {
      ...
      "description": "The google-services.json from the Firebase console. Android: copied into the Android project, where the google-services Gradle plugin reads it. Windows, macOS and Linux: copied beside the executable (into the app bundle\u0027s resources on macOS), where firebase_app_initialize looks for it.",
    ...
    },
    {
      ...
      "description": "The GoogleService-Info.plist from the Firebase console. iOS: copied into the Xcode project\u0027s resources, where the SDK reads it.",
