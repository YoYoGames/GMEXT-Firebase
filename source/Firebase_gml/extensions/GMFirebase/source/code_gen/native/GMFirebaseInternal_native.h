...
namespace gm_enums
{
    enum class FirebaseError : std::int64_t
    {
        Ok = 0,
        InvalidHandle = -1000,
        NotInitialized = -1001,
    ...
    enum class FirebaseAppCheckError : std::int64_t
    {
        None = 0,
        ServerUnreachable = 1,
    ...
    enum class FirestoreFieldValueType : std::int64_t
    {
        Null = 0,
        Boolean = 1,
        Integer = 2,
    ...
    enum class FirebaseStorageError : std::int64_t
    {
        None = 0,
        Unknown = 1,
        ObjectNotFound = 2,
    ...
    enum class FirebaseFunctionsError : std::int64_t
    {
        None = 0,
        Cancelled = 1,
        Unknown = 2,
    ...
    enum class FirebaseRemoteConfigError : std::int64_t
    {
        Unimplemented = -1,
        None = 0,
    ...
    enum class FirebaseMessagingError : std::int64_t
    {
        None = 0,
    ...
    enum class FirebaseUmpConsentRequestError : std::int64_t
    {
        Success = 0,
        InvalidAppId = 1,
        Network = 2,
    ...
    enum class FirebaseUmpConsentFormError : std::int64_t
    {
        Success = 0,
        Timeout = 1,
        Internal = 2,
    ...
    enum class FirebaseAnalyticsAppLifecycleState : std::int64_t
    {
        Unknown = 0,
        Termination = 1
    };

    enum class FirestoreAggregateSource : std::int64_t
    {
        Server = 0
    };
...
namespace gm_structs
{
    ...
    {
        double fetch_time;
        gm_enums::FirebaseRemoteConfigLastFetchStatus last_fetch_status;
        gm_enums::FirebaseRemoteConfigFetchFailureReason last_fetch_failure_reason;
...
namespace gm::wire::codec
{
    ...
    template<>
    inline void writeValue<gm_structs::FirebaseMutableDataInfo>(gm::byteio::IByteWriter& _buf, const gm_structs::FirebaseMutableDataInfo& obj)
    {
        gm::wire::codec::writeValue(_buf, obj.key);
        gm::wire::codec::writeValue(_buf, obj.children_count);
    }
    ...
    template<>
    inline gm_structs::FirebaseMutableDataInfo readValue<gm_structs::FirebaseMutableDataInfo>(gm::byteio::BufferReader& _buf)
    {
        gm_structs::FirebaseMutableDataInfo obj;
        obj.key = gm::wire::codec::readValue<std::string>(_buf);
        obj.children_count = gm::wire::codec::readValue<double>(_buf);
        return obj;
    }
    ...
    template<>
    inline void writeValue<gm_structs::FirestoreReference>(gm::byteio::IByteWriter& _buf, const gm_structs::FirestoreReference& obj)
    {
        gm::wire::codec::writeValue(_buf, obj.path);
    }

    template<>
    inline gm_structs::FirestoreReference readValue<gm_structs::FirestoreReference>(gm::byteio::BufferReader& _buf)
    {
        gm_structs::FirestoreReference obj;
    ...
    inline gm_structs::FirestoreFieldPathValue readValue<gm_structs::FirestoreFieldPathValue>(gm::byteio::BufferReader& _buf)
    {
        ...
        obj.field_path = gm::wire::codec::readValue<std::uint64_t>(_buf);
        obj.value = gm::wire::codec::readValue<gm::wire::DataStream>(_buf);
        return obj;
    }
    ...
    inline gm_structs::FirebaseRemoteConfigInfo readValue<gm_structs::FirebaseRemoteConfigInfo>(gm::byteio::BufferReader& _buf)
    {
        ...
        obj.last_fetch_status = gm::wire::codec::readValue<gm_enums::FirebaseRemoteConfigLastFetchStatus>(_buf);
        obj.last_fetch_failure_reason = gm::wire::codec::readValue<gm_enums::FirebaseRemoteConfigFetchFailureReason>(_buf);
...
namespace gm::wire::details
{
    ...
    template<>
    struct gm_struct_traits<gm_structs::FirebaseMutableDataInfo>
    {
        static constexpr bool is_gm_struct = true;
    ...
    template<>
    struct gm_struct_traits<gm_structs::FirestoreBlob>
    {
        static constexpr bool is_gm_struct = true;
    ...
    template<>
    struct gm_struct_traits<gm_structs::FirestoreReference>
    {
        static constexpr bool is_gm_struct = true;
...
gm_enums::FirebaseError firebase_analytics_get_analytics_instance_id(const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_analytics_get_session_id(const std::optional<gm::wire::GMFunction>& callback);
...
void firebase_app_check_set_provider_factory(gm_enums::FirebaseAppCheckProvider provider);
void firebase_app_check_debug_provider_set_debug_token(std::string_view token);
std::uint64_t firebase_app_check_get_instance();
std::uint64_t firebase_app_check_get_instance_for_app(std::uint64_t app);
std::uint64_t firebase_app_check_get_app(std::uint64_t app_check);
void firebase_app_check_set_token_auto_refresh_enabled(std::uint64_t app_check, bool enabled);
gm_enums::FirebaseError firebase_app_check_get_token(std::uint64_t app_check, bool force_refresh, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_app_check_get_limited_use_token(std::uint64_t app_check, const std::optional<gm::wire::GMFunction>& callback);
std::uint64_t firebase_app_check_add_listener(std::uint64_t app_check, const std::optional<gm::wire::GMFunction>& callback);
bool firebase_app_check_remove_listener(std::uint64_t listener_ref);
std::uint64_t firebase_installations_get_instance();
std::uint64_t firebase_installations_get_instance_for_app(std::uint64_t app);
std::uint64_t firebase_installations_get_app(std::uint64_t installations);
gm_enums::FirebaseError firebase_installations_get_id(std::uint64_t installations, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_installations_get_token(std::uint64_t installations, bool force_refresh, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_installations_delete(std::uint64_t installations, const std::optional<gm::wire::GMFunction>& callback);
...
gm_enums::FirebaseError firebase_auth_fetch_providers_for_email(std::string_view email, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_auth_sign_in_with_custom_token(std::string_view custom_token, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_auth_sign_in_with_credential(std::uint64_t credential_ref, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_auth_sign_in_and_retrieve_data_with_credential(std::uint64_t credential_ref, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_auth_sign_in_anonymously(const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_auth_sign_in_with_email_and_password(std::string_view email, std::string_view password, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_auth_create_user_with_email_and_password(std::string_view email, std::string_view password, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_auth_send_password_reset_email(std::string_view email, const std::optional<gm::wire::GMFunction>& callback);
...
gm_enums::FirebaseError firebase_auth_game_center_auth_provider_get_credential(const std::optional<gm::wire::GMFunction>& callback);
...
std::optional<gm_structs::FirebaseAuthUserInfo> firebase_auth_user_get_info(std::uint64_t user);
void firebase_auth_user_release(std::uint64_t user_ref);
bool firebase_auth_user_is_valid(std::uint64_t user_ref);
gm_enums::FirebaseError firebase_auth_user_get_token(std::uint64_t user_ref, bool force_refresh, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_auth_user_update_password(std::uint64_t user_ref, std::string_view password, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_auth_user_update_profile(std::uint64_t user_ref, std::string_view display_name, std::string_view photo_url, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_auth_user_send_email_verification(std::uint64_t user_ref, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_auth_user_send_email_verification_before_updating_email(std::uint64_t user_ref, std::string_view new_email, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_auth_user_reauthenticate(std::uint64_t user_ref, std::uint64_t credential_ref, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_auth_user_reauthenticate_and_retrieve_data(std::uint64_t user_ref, std::uint64_t credential_ref, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_auth_user_link_with_credential(std::uint64_t user_ref, std::uint64_t credential_ref, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_auth_user_unlink(std::uint64_t user_ref, std::string_view provider_id, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_auth_user_reload(std::uint64_t user_ref, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_auth_user_delete(std::uint64_t user_ref, const std::optional<gm::wire::GMFunction>& callback);
...
bool firebase_database_go_offline(std::uint64_t db_ref);
bool firebase_database_go_online(std::uint64_t db_ref);
bool firebase_database_purge_outstanding_writes(std::uint64_t db_ref);
bool firebase_database_set_persistence_enabled(std::uint64_t db_ref, bool enabled);
bool firebase_database_set_log_level(std::uint64_t db_ref, gm_enums::FirebaseLogLevel log_level);
...
bool firebase_database_query_set_keep_synchronized(std::uint64_t ref, bool keep_sync);
bool firebase_database_query_is_valid(std::uint64_t ref);
gm_enums::FirebaseError firebase_database_query_get_value(std::uint64_t ref, const std::optional<gm::wire::GMFunction>& callback);
...
bool firebase_database_query_remove_value_listener(std::uint64_t ref, std::uint64_t listener_ref);
bool firebase_database_query_remove_all_value_listeners(std::uint64_t ref);
...
bool firebase_database_query_remove_child_listener(std::uint64_t ref, std::uint64_t listener_ref);
bool firebase_database_query_remove_all_child_listeners(std::uint64_t ref);
void firebase_database_query_release(std::uint64_t ref);
std::optional<gm_structs::FirebaseDatabaseReferenceInfo> firebase_database_ref_get(std::uint64_t ref);
...
bool firebase_database_ref_go_online(std::uint64_t ref);
bool firebase_database_ref_go_offline(std::uint64_t ref);
gm_enums::FirebaseError firebase_database_ref_set_value(std::uint64_t ref, const gm::wire::GMValue& value, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_database_ref_set_priority(std::uint64_t ref, const gm::wire::GMValue& priority, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_database_ref_set_value_and_priority(std::uint64_t ref, const gm::wire::GMValue& value, const gm::wire::GMValue& priority, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_database_ref_update_children(std::uint64_t ref, const gm::wire::GMValue& values, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_database_ref_remove_value(std::uint64_t ref, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_database_ref_run_transaction(std::uint64_t ref, bool trigger_local_events, const std::optional<gm::wire::GMFunction>& update_callback, const std::optional<gm::wire::GMFunction>& callback);
void firebase_database_ref_release(std::uint64_t ref);
bool firebase_database_snapshot_is_valid(std::uint64_t ref);
std::uint64_t firebase_database_snapshot_child(std::uint64_t ref, std::string_view path);
bool firebase_database_snapshot_has_child(std::uint64_t ref, std::string_view path);
...
std::optional<gm_structs::FirebaseDataSnapshotInfo> firebase_database_snapshot_get_info(std::uint64_t snapshot);
...
void firebase_database_snapshot_release(std::uint64_t snapshot);
std::optional<gm_structs::FirebaseMutableDataInfo> firebase_database_mutable_data_get_info(std::uint64_t data);
std::uint64_t firebase_database_mutable_data_child(std::uint64_t data, std::string_view path);
bool firebase_database_mutable_data_has_child(std::uint64_t data, std::string_view path);
std::vector<std::uint64_t> firebase_database_mutable_data_get_children(std::uint64_t data);
gm::wire::DataStream firebase_database_mutable_data_get_value(std::uint64_t data);
gm::wire::DataStream firebase_database_mutable_data_get_priority(std::uint64_t data);
bool firebase_database_mutable_data_set_value(std::uint64_t data, const gm::wire::GMValue& value);
bool firebase_database_mutable_data_set_priority(std::uint64_t data, const gm::wire::GMValue& priority);
bool firebase_database_transaction_commit(std::uint64_t data);
bool firebase_database_transaction_abort(std::uint64_t data);
...
void firebase_firestore_set_log_level(gm_enums::FirebaseLogLevel level);
gm_enums::FirebaseError firebase_firestore_enable_network(std::uint64_t instance_ref, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_firestore_disable_network(std::uint64_t instance_ref, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_firestore_terminate(std::uint64_t instance_ref, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_firestore_clear_persistence(std::uint64_t instance_ref, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_firestore_wait_for_pending_writes(std::uint64_t instance_ref, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_firestore_run_transaction(std::uint64_t instance_ref, double max_attempts, const std::optional<gm::wire::GMFunction>& update_callback, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_firestore_transaction_get(std::uint64_t transaction_ref, std::uint64_t document_ref, const std::optional<gm::wire::GMFunction>& callback);
bool firebase_firestore_transaction_set(std::uint64_t transaction_ref, std::uint64_t document_ref, const gm::wire::GMValue& data);
bool firebase_firestore_transaction_set_merge(std::uint64_t transaction_ref, std::uint64_t document_ref, const gm::wire::GMValue& data);
bool firebase_firestore_transaction_set_merge_fields(std::uint64_t transaction_ref, std::uint64_t document_ref, const gm::wire::GMValue& data, const std::vector<std::string_view>& fields);
bool firebase_firestore_transaction_set_merge_field_paths(std::uint64_t transaction_ref, std::uint64_t document_ref, const gm::wire::GMValue& data, const std::vector<std::uint64_t>& field_paths);
bool firebase_firestore_transaction_update(std::uint64_t transaction_ref, std::uint64_t document_ref, const gm::wire::GMValue& data);
bool firebase_firestore_transaction_update_field_paths(std::uint64_t transaction_ref, std::uint64_t document_ref, const std::vector<gm_structs::FirestoreFieldPathValue>& entries);
bool firebase_firestore_transaction_delete(std::uint64_t transaction_ref, std::uint64_t document_ref);
bool firebase_firestore_transaction_commit(std::uint64_t transaction_ref);
bool firebase_firestore_transaction_abort(std::uint64_t transaction_ref, std::string_view error_message);
...
gm_enums::FirebaseError firebase_firestore_collection_ref_add(std::uint64_t ref, const gm::wire::GMValue& data, const std::optional<gm::wire::GMFunction>& callback);
...
gm_enums::FirebaseError firebase_firestore_document_ref_get(std::uint64_t ref, gm_enums::FirestoreSource source, const std::optional<gm::wire::GMFunction>& callback);
...
std::uint64_t firebase_firestore_query_order_by(std::uint64_t ref, std::string_view field, gm_enums::FirestoreDirection direction);
...
gm_enums::FirebaseError firebase_firestore_query_get(std::uint64_t ref, gm_enums::FirestoreSource source, const std::optional<gm::wire::GMFunction>& callback);
...
bool firebase_firestore_write_batch_set(std::uint64_t batch_ref, std::uint64_t document_ref, const gm::wire::GMValue& data);
bool firebase_firestore_write_batch_set_merge(std::uint64_t batch_ref, std::uint64_t document_ref, const gm::wire::GMValue& data);
bool firebase_firestore_write_batch_set_merge_fields(std::uint64_t batch_ref, std::uint64_t document_ref, const gm::wire::GMValue& data, const std::vector<std::string_view>& fields);
bool firebase_firestore_write_batch_update(std::uint64_t batch_ref, std::uint64_t document_ref, const gm::wire::GMValue& data);
bool firebase_firestore_write_batch_delete(std::uint64_t batch_ref, std::uint64_t document_ref);
...
std::uint64_t firebase_firestore_field_value_blob(gm::wire::GMBuffer data);
std::uint64_t firebase_firestore_field_value_null();
void firebase_firestore_field_value_release(std::uint64_t ref);
std::optional<gm_structs::FirestoreDocumentSnapshotInfo> firebase_firestore_document_snapshot_get_info(std::uint64_t ref);
std::optional<gm_structs::FirestoreFieldLookup> firebase_firestore_document_snapshot_get(std::uint64_t ref, std::string_view field, gm_enums::FirestoreServerTimestampBehavior server_timestamp_behavior);
gm::wire::DataStream firebase_firestore_document_snapshot_get_data(std::uint64_t ref, gm_enums::FirestoreServerTimestampBehavior server_timestamp_behavior);
void firebase_firestore_document_snapshot_release(std::uint64_t ref);
std::optional<gm_structs::FirestoreQuerySnapshotInfo> firebase_firestore_query_snapshot_get_info(std::uint64_t ref);
...
void firebase_storage_ref_release(std::uint64_t ref);
...
bool firebase_storage_ref_is_valid(std::uint64_t ref);
std::uint64_t firebase_storage_ref_storage(std::uint64_t ref);
gm_enums::FirebaseError firebase_storage_ref_delete(std::uint64_t ref, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_storage_ref_get_download_url(std::uint64_t ref, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_storage_ref_get_metadata(std::uint64_t ref, const std::optional<gm::wire::GMFunction>& callback);
...
void firebase_storage_metadata_release(std::uint64_t ref);
bool firebase_storage_metadata_is_valid(std::uint64_t ref);
...
void firebase_storage_controller_release(std::uint64_t ref);
bool firebase_storage_controller_is_valid(std::uint64_t ref);
bool firebase_storage_controller_pause(std::uint64_t ref);
bool firebase_storage_controller_resume(std::uint64_t ref);
bool firebase_storage_controller_cancel(std::uint64_t ref);
bool firebase_storage_controller_is_paused(std::uint64_t ref);
...
void firebase_storage_list_result_release(std::uint64_t ref);
bool firebase_storage_list_result_is_valid(std::uint64_t ref);
...
std::uint64_t firebase_functions_get_https_callable(std::uint64_t functions_ref, std::string_view name, bool limited_use_app_check_token);
std::uint64_t firebase_functions_get_https_callable_from_url(std::uint64_t functions_ref, std::string_view url, bool limited_use_app_check_token);
bool firebase_functions_callable_is_valid(std::uint64_t ref);
void firebase_functions_callable_release(std::uint64_t ref);
gm_enums::FirebaseError firebase_functions_callable_call(std::uint64_t ref, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_functions_callable_call_with_data(std::uint64_t ref, const gm::wire::GMValue& data, const std::optional<gm::wire::GMFunction>& callback);
std::uint64_t firebase_remote_config_get_instance();
gm_enums::FirebaseError firebase_remote_config_ensure_initialized(std::uint64_t rc_ref, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_remote_config_set_config_settings(std::uint64_t rc_ref, double fetch_timeout_ms, double minimum_fetch_interval_ms, const std::optional<gm::wire::GMFunction>& callback);
...
gm_enums::FirebaseError firebase_remote_config_fetch(std::uint64_t rc_ref, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_remote_config_fetch_with_expiration(std::uint64_t rc_ref, double cache_expiration_in_seconds, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_remote_config_fetch_and_activate(std::uint64_t rc_ref, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_remote_config_activate(std::uint64_t rc_ref, const std::optional<gm::wire::GMFunction>& callback);
bool firebase_remote_config_get_boolean(std::uint64_t rc_ref, std::string_view key);
...
gm_enums::FirebaseError firebase_remote_config_get_keys_by_prefix(std::uint64_t rc_ref, std::string_view prefix, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_remote_config_get_keys(std::uint64_t rc_ref, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_remote_config_get_all(std::uint64_t rc_ref, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_remote_config_set_defaults(std::uint64_t rc_ref, const gm::wire::GMValue& defaults, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_remote_config_set_custom_signals(std::uint64_t rc_ref, const gm::wire::GMValue& signals, const std::optional<gm::wire::GMFunction>& callback);
std::optional<gm_structs::FirebaseRemoteConfigInfo> firebase_remote_config_get_info(std::uint64_t rc_ref);
...
bool firebase_remote_config_remove_config_update_listener(std::uint64_t reg_ref);
...
gm_enums::FirebaseError firebase_messaging_request_permission(const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_messaging_register(const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_messaging_unregister(const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_messaging_get_token(const std::optional<gm::wire::GMFunction>& callback);
...
bool firebase_ump_can_request_ads(std::uint64_t consent_ref);
...
std::vector<gm_structs::FirebaseAuthProviderUserInfo> firebase_auth_user_provider_data(std::uint64_t user);
...
gm_enums::FirebaseError firebase_auth_user_update_phone_number_credential(std::uint64_t user, std::uint64_t phone_credential, const std::optional<gm::wire::GMFunction>& callback);
bool firebase_database_ref_is_valid(std::uint64_t ref);
...
gm_enums::FirebaseError firebase_database_on_disconnect_cancel(std::uint64_t handler, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_database_on_disconnect_remove_value(std::uint64_t handler, const std::optional<gm::wire::GMFunction>& callback);
gm_enums::FirebaseError firebase_database_on_disconnect_set_value(std::uint64_t handler, const gm::wire::GMValue& value, const std::optional<gm::wire::GMFunction>& callback);
...
std::uint64_t firebase_firestore_field_path_create(const std::vector<std::string_view>& components);
std::uint64_t firebase_firestore_field_path_document_id();
...
std::uint64_t firebase_firestore_filter_equal_to(std::string_view field, const gm::wire::GMValue& value);
std::uint64_t firebase_firestore_filter_not_equal_to(std::string_view field, const gm::wire::GMValue& value);
std::uint64_t firebase_firestore_filter_less_than(std::string_view field, const gm::wire::GMValue& value);
std::uint64_t firebase_firestore_filter_less_than_or_equal_to(std::string_view field, const gm::wire::GMValue& value);
std::uint64_t firebase_firestore_filter_greater_than(std::string_view field, const gm::wire::GMValue& value);
std::uint64_t firebase_firestore_filter_greater_than_or_equal_to(std::string_view field, const gm::wire::GMValue& value);
std::uint64_t firebase_firestore_filter_array_contains(std::string_view field, const gm::wire::GMValue& value);
std::uint64_t firebase_firestore_filter_array_contains_any(std::string_view field, const gm::wire::GMValue& values);
std::uint64_t firebase_firestore_filter_in(std::string_view field, const gm::wire::GMValue& values);
std::uint64_t firebase_firestore_filter_not_in(std::string_view field, const gm::wire::GMValue& values);
std::uint64_t firebase_firestore_filter_equal_to_field_path(std::uint64_t field_path, const gm::wire::GMValue& value);
std::uint64_t firebase_firestore_filter_not_equal_to_field_path(std::uint64_t field_path, const gm::wire::GMValue& value);
std::uint64_t firebase_firestore_filter_less_than_field_path(std::uint64_t field_path, const gm::wire::GMValue& value);
std::uint64_t firebase_firestore_filter_less_than_or_equal_to_field_path(std::uint64_t field_path, const gm::wire::GMValue& value);
std::uint64_t firebase_firestore_filter_greater_than_field_path(std::uint64_t field_path, const gm::wire::GMValue& value);
std::uint64_t firebase_firestore_filter_greater_than_or_equal_to_field_path(std::uint64_t field_path, const gm::wire::GMValue& value);
std::uint64_t firebase_firestore_filter_array_contains_field_path(std::uint64_t field_path, const gm::wire::GMValue& value);
std::uint64_t firebase_firestore_filter_array_contains_any_field_path(std::uint64_t field_path, const gm::wire::GMValue& values);
std::uint64_t firebase_firestore_filter_in_field_path(std::uint64_t field_path, const gm::wire::GMValue& values);
std::uint64_t firebase_firestore_filter_not_in_field_path(std::uint64_t field_path, const gm::wire::GMValue& values);
std::uint64_t firebase_firestore_filter_and(const std::vector<std::uint64_t>& filters);
std::uint64_t firebase_firestore_filter_or(const std::vector<std::uint64_t>& filters);
...
std::uint64_t firebase_firestore_query_order_by_field_path(std::uint64_t query, std::uint64_t field_path, gm_enums::FirestoreDirection direction);
...
gm_enums::FirebaseError firebase_firestore_aggregate_query_get(std::uint64_t aggregate_query, gm_enums::FirestoreAggregateSource source, const std::optional<gm::wire::GMFunction>& callback);
...
gm_enums::FirebaseError firebase_firestore_document_ref_set_merge_field_paths(std::uint64_t document, const gm::wire::GMValue& data, const std::vector<std::uint64_t>& field_paths, const std::optional<gm::wire::GMFunction>& callback);
bool firebase_firestore_write_batch_set_merge_field_paths(std::uint64_t batch, std::uint64_t document, const gm::wire::GMValue& data, const std::vector<std::uint64_t>& field_paths);
...
gm_enums::FirestoreFieldValueType firebase_firestore_field_value_type(std::uint64_t field_value);
...
bool firebase_firestore_write_batch_update_field_paths(std::uint64_t batch, std::uint64_t document, const std::vector<gm_structs::FirestoreFieldPathValue>& entries);
...
std::optional<gm_structs::FirestoreFieldLookup> firebase_firestore_document_snapshot_get_field_path(std::uint64_t snapshot, std::uint64_t field_path, gm_enums::FirestoreServerTimestampBehavior server_timestamp_behavior);
...
std::uint64_t firebase_firestore_field_value_boolean(bool value);
std::uint64_t firebase_firestore_field_value_string(std::string_view value);
std::uint64_t firebase_firestore_field_value_array(const gm::wire::GMValue& value);
std::uint64_t firebase_firestore_field_value_map(const gm::wire::GMValue& value);
...
gm_enums::FirebaseError firebase_auth_game_center_auth_provider_get_credential_last_result(const std::optional<gm::wire::GMFunction>& callback);
