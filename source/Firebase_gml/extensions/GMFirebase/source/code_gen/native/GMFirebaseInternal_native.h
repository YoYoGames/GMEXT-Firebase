...
std::uint64_t firebase_firestore_field_path_create(const gm::wire::GMValue& components);
...
std::uint64_t firebase_firestore_filter_and(const gm::wire::GMValue& filters);
std::uint64_t firebase_firestore_filter_or(const gm::wire::GMValue& filters);
