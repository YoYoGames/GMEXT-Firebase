...
{
	return firebase::auth::EmailAuthProvider::kProviderId;
}
std::string firebase_auth_facebook_auth_provider_id()
{
	return firebase::auth::FacebookAuthProvider::kProviderId;
}
std::string firebase_auth_game_center_auth_provider_id()
{
	return firebase::auth::GameCenterAuthProvider::kProviderId;
}
std::string firebase_auth_github_auth_provider_id()
{
	return firebase::auth::GitHubAuthProvider::kProviderId;
}
std::string firebase_auth_google_auth_provider_id()
{
	return firebase::auth::GoogleAuthProvider::kProviderId;
}
std::string firebase_auth_microsoft_auth_provider_id()
{
	return firebase::auth::MicrosoftAuthProvider::kProviderId;
}
std::string firebase_auth_play_games_auth_provider_id()
{
	return firebase::auth::PlayGamesAuthProvider::kProviderId;
}
std::string firebase_auth_twitter_auth_provider_id()
{
	return firebase::auth::TwitterAuthProvider::kProviderId;
}
std::string firebase_auth_yahoo_auth_provider_id()
{
	return firebase::auth::YahooAuthProvider::kProviderId;
}
