# Native linking for GMFirebaseAnalytics

`GMFirebaseAnalytics` requires `GMFirebaseCore` in the GameMaker project.

- Firebase C++ product library: `analytics`.
...
- The original `firebase_analytics_*` ExtGen-facing function names/signatures are preserved.
