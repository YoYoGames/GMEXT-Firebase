...
void Init_GMFirebaseAnalytics()
{
    ...
    libHandle = ExtUtils_GetLibraryHandle("GMFirebaseAnalytics.ext");
    if (libHandle)
    {
...
void Startup_GMFirebaseAnalytics()
{
...
void Shutdown_GMFirebaseAnalytics()
{
    if (!isInitialized) return;
