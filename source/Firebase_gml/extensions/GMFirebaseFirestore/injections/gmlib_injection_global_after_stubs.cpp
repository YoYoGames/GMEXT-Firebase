...
void Init_GMFirebaseFirestore()
{
    ...
    libHandle = ExtUtils_GetLibraryHandle("GMFirebaseFirestore.ext");
    if (libHandle)
    {
...
void Startup_GMFirebaseFirestore()
{
...
void Shutdown_GMFirebaseFirestore()
{
    if (!isInitialized) return;
