...
@interface GMFirebaseFirestoreInternal : NSObject
...
- (double)__EXT_NATIVE__GMFirebaseFirestore_invocation_handler:(char*)__ret_buffer arg1:(double)__ret_buffer_length;
