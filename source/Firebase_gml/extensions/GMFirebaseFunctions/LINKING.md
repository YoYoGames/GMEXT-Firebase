# Native linking for GMFirebaseFunctions

`GMFirebaseFunctions` requires `GMFirebaseCore` in the GameMaker project.

- Firebase C++ product library: `functions`.
...
- The original `firebase_functions_*` ExtGen-facing function names/signatures are preserved.
