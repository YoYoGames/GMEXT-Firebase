...
void Init_GMFirebaseFunctions()
{
    ...
    libHandle = ExtUtils_GetLibraryHandle("GMFirebaseFunctions.ext");
    if (libHandle)
    {
...
void Startup_GMFirebaseFunctions()
{
...
void Shutdown_GMFirebaseFunctions()
{
    if (!isInitialized) return;
