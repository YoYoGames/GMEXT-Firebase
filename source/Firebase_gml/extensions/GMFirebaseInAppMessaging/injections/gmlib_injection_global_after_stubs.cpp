...
void Init_GMFirebaseInAppMessaging()
{
    ...
    libHandle = ExtUtils_GetLibraryHandle("GMFirebaseInAppMessaging.ext");
    if (libHandle)
    {
...
void Startup_GMFirebaseInAppMessaging()
{
...
void Shutdown_GMFirebaseInAppMessaging()
{
    if (!isInitialized) return;
