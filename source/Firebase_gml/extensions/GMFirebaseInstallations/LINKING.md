# Native linking for GMFirebaseInstallations

`GMFirebaseInstallations` requires `GMFirebaseCore` in the GameMaker project.

- Firebase C++ product library: `installations`.
...
- The original `firebase_installations_*` ExtGen-facing function names/signatures are preserved.
