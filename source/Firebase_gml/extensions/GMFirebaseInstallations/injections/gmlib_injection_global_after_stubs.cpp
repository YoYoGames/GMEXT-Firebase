...
void Init_GMFirebaseInstallations()
{
    ...
    libHandle = ExtUtils_GetLibraryHandle("GMFirebaseInstallations.ext");
    if (libHandle)
    {
...
void Startup_GMFirebaseInstallations()
{
...
void Shutdown_GMFirebaseInstallations()
{
    if (!isInitialized) return;
