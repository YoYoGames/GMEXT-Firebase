...
#include <algorithm>
#include <string>
#include "native/GMFirebaseInstallationsInternal_exports.h"
...
// __GMFirebaseInstallations_invocation_handler JNI wrapper signature: (Ljava/nio/ByteBuffer;D)D
static jdouble __JNI_WRAPPER__GMFirebaseInstallations_invocation_handler(JNIEnv* env, jclass /* GMFirebaseInstallationsBridge */, jobject __ret_buffer, jdouble __ret_buffer_length)
{
    ...
    double __ret = __EXT_NATIVE__GMFirebaseInstallations_invocation_handler((char *)__ret_buffer_ptr, static_cast<double>(__ret_buffer_length));
    return static_cast<jdouble>(__ret);
}
// firebase_installations_get_id JNI wrapper signature: (Ljava/nio/ByteBuffer;D)D
static jdouble __JNI_WRAPPER__firebase_installations_get_id_D476421F026B(JNIEnv* env, jclass /* GMFirebaseInstallationsBridge */, jobject __arg_buffer, jdouble __arg_buffer_length)
{
...
static jdouble __JNI_WRAPPER__firebase_installations_get_token_E465C5E9A920(JNIEnv* env, jclass /* GMFirebaseInstallationsBridge */, jobject __arg_buffer, jdouble __arg_buffer_length)
{
    void* __arg_buffer_ptr = env->GetDirectBufferAddress(__arg_buffer);
    jlong __arg_buffer_cap = env->GetDirectBufferCapacity(__arg_buffer);
    if (!__arg_buffer_ptr || __arg_buffer_cap <= 0) {
...
static jdouble __JNI_WRAPPER__firebase_installations_delete_ECD2B16D403F(JNIEnv* env, jclass /* GMFirebaseInstallationsBridge */, jobject __arg_buffer, jdouble __arg_buffer_length)
{
    void* __arg_buffer_ptr = env->GetDirectBufferAddress(__arg_buffer);
    jlong __arg_buffer_cap = env->GetDirectBufferCapacity(__arg_buffer);
    if (!__arg_buffer_ptr || __arg_buffer_cap <= 0) {
...
static jdouble __JNI_WRAPPER__firebase_installations_get_app_29FB398634B8(JNIEnv* env, jclass /* GMFirebaseInstallationsBridge */, jobject __ret_buffer, jdouble __ret_buffer_length)
{
    void* __ret_buffer_ptr = env->GetDirectBufferAddress(__ret_buffer);
    jlong __ret_buffer_cap = env->GetDirectBufferCapacity(__ret_buffer);
    if (!__ret_buffer_ptr || __ret_buffer_cap <= 0) {
...
static jdouble __JNI_WRAPPER__firebase_installations_get_instance_handle_ABB14A64F7F2(JNIEnv* env, jclass /* GMFirebaseInstallationsBridge */, jobject __ret_buffer, jdouble __ret_buffer_length)
{
    void* __ret_buffer_ptr = env->GetDirectBufferAddress(__ret_buffer);
    jlong __ret_buffer_cap = env->GetDirectBufferCapacity(__ret_buffer);
    if (!__ret_buffer_ptr || __ret_buffer_cap <= 0) {
...
static jdouble __JNI_WRAPPER__firebase_installations_get_instance_for_app_D6CBA7FC6CA5(JNIEnv* env, jclass /* GMFirebaseInstallationsBridge */, jobject __arg_buffer, jdouble __arg_buffer_length, jobject __ret_buffer, jdouble __ret_buffer_length)
{
    void* __arg_buffer_ptr = env->GetDirectBufferAddress(__arg_buffer);
    jlong __arg_buffer_cap = env->GetDirectBufferCapacity(__arg_buffer);
    if (!__arg_buffer_ptr || __arg_buffer_cap <= 0) {
...
static jdouble __JNI_WRAPPER__firebase_installations_instance_get_app_7B69B5ED6EF0(JNIEnv* env, jclass /* GMFirebaseInstallationsBridge */, jobject __arg_buffer, jdouble __arg_buffer_length, jobject __ret_buffer, jdouble __ret_buffer_length)
{
    void* __arg_buffer_ptr = env->GetDirectBufferAddress(__arg_buffer);
    jlong __arg_buffer_cap = env->GetDirectBufferCapacity(__arg_buffer);
    if (!__arg_buffer_ptr || __arg_buffer_cap <= 0) {
...
static jdouble __JNI_WRAPPER__firebase_installations_instance_get_id_27FC03CDF6A9(JNIEnv* env, jclass /* GMFirebaseInstallationsBridge */, jobject __arg_buffer, jdouble __arg_buffer_length)
{
    void* __arg_buffer_ptr = env->GetDirectBufferAddress(__arg_buffer);
    jlong __arg_buffer_cap = env->GetDirectBufferCapacity(__arg_buffer);
    if (!__arg_buffer_ptr || __arg_buffer_cap <= 0) {
...
static jdouble __JNI_WRAPPER__firebase_installations_instance_get_token_79D8273A16CA(JNIEnv* env, jclass /* GMFirebaseInstallationsBridge */, jobject __arg_buffer, jdouble __arg_buffer_length)
{
    void* __arg_buffer_ptr = env->GetDirectBufferAddress(__arg_buffer);
    jlong __arg_buffer_cap = env->GetDirectBufferCapacity(__arg_buffer);
    if (!__arg_buffer_ptr || __arg_buffer_cap <= 0) {
...
static jdouble __JNI_WRAPPER__firebase_installations_instance_delete_C2FC60CDEC3C(JNIEnv* env, jclass /* GMFirebaseInstallationsBridge */, jobject __arg_buffer, jdouble __arg_buffer_length)
{
    void* __arg_buffer_ptr = env->GetDirectBufferAddress(__arg_buffer);
    jlong __arg_buffer_cap = env->GetDirectBufferCapacity(__arg_buffer);
    if (!__arg_buffer_ptr || __arg_buffer_cap <= 0) {
...
extern "C" {
    JNIEXPORT void JNICALL Java_com_gamemaker_ExtensionCore_ExtBridge_GMFirebaseInstallationsBridge_nativeRegister(JNIEnv* env, jclass bridgeClass)
    {
        if (!g_bridgeClass) {
        ...
        static const JNINativeMethod methods[] = {
            { "__EXT_JNI__GMFirebaseInstallations_invocation_handler", "(Ljava/nio/ByteBuffer;D)D", (void*)__JNI_WRAPPER__GMFirebaseInstallations_invocation_handler },
