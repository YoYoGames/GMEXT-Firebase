...
`GMFirebaseMessaging` requires `GMFirebaseCore` in the GameMaker project.

- Firebase C++ product library: `messaging`.
...
- The original `firebase_messaging_*` ExtGen-facing function names/signatures are preserved.
