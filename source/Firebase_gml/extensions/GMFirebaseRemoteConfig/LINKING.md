# Native linking for GMFirebaseRemoteConfig

`GMFirebaseRemoteConfig` requires `GMFirebaseCore` in the GameMaker project.

- Firebase C++ product library: `remote_config`.
...
- The original `firebase_remote_config_*` ExtGen-facing function names/signatures are preserved.
