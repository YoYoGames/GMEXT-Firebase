...
void Init_GMFirebaseRemoteConfig()
{
    ...
    libHandle = ExtUtils_GetLibraryHandle("GMFirebaseRemoteConfig.ext");
    if (libHandle)
    {
...
void Startup_GMFirebaseRemoteConfig()
{
...
void Shutdown_GMFirebaseRemoteConfig()
{
    if (!isInitialized) return;
