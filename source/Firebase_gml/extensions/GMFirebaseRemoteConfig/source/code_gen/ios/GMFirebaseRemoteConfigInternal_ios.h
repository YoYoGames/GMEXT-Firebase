...
@interface GMFirebaseRemoteConfigInternal : NSObject
...
- (double)__EXT_NATIVE__GMFirebaseRemoteConfig_invocation_handler:(char*)__ret_buffer arg1:(double)__ret_buffer_length;
