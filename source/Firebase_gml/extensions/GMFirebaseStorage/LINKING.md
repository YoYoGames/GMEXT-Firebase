# Native linking for GMFirebaseStorage

`GMFirebaseStorage` requires `GMFirebaseCore` in the GameMaker project.

- Firebase C++ product library: `storage`.
...
- The original `firebase_storage_*` ExtGen-facing function names/signatures are preserved.
