# Native linking for GMFirebaseUMP

`GMFirebaseUMP` requires `GMFirebaseCore` in the GameMaker project.

- Firebase C++ product library: `ump`.
...
- The original `firebase_ump_*` ExtGen-facing function names/signatures are preserved.
