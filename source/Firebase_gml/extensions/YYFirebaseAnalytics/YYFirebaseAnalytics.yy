{
  ...
  "files":[
    {"$GMExtensionFile":"v1","%Name":"FirebaseAnalytics.ext","constants":[
        ...
        {"$GMExtensionFunction":"","%Name":"FirebaseAnalytics_SetConsent","argCount":0,"args":[2,2,2,2,],"documentation":"/// @desc Sets the user consent state for analytics and ad storage. A value greater than or equal to `0.5` grants consent, while a value below `0.5` denies it.\r\n/// @param {real} adsConsent Consent state for ad storage (>= 0.5 for `GRANTED`).\r\n/// @param {real} analyticsConsent Consent state for analytics storage (>= 0.5 for `GRANTED`).\r\n/// @param {real} adUserDataConsent Consent state for ad storage (>= 0.5 for `GRANTED`).\r\n/// @param {real} adPersonalizationConsent Consent state for analytics storage (>= 0.5 for `GRANTED`).\r\n/// @return {real}\r\n","externalName":"FirebaseAnalytics_SetConsent","help":"FirebaseAnalytics_SetConsent(adsConsent, analyticsConsent, adUserDataConsent, adPersonalizationConsent)","hidden":false,"kind":4,"name":"FirebaseAnalytics_SetConsent","resourceType":"GMExtensionFunction","resourceVersion":"2.0","returnType":2,},
      ],"init":"","kind":4,"name":"FirebaseAnalytics.ext","origname":"","ProxyFiles":[
  ...
  "parent":{
    "name":"Extensions",
    "path":"folders/Firebase/Firebase Analytics/Extensions.yy",
  },
  "productId":"",
