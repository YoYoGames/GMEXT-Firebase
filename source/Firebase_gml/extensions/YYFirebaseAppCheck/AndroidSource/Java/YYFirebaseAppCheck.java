...
public class YYFirebaseAppCheck
{
	...
	public void FirebaseAppCheck_Init_Extension()
	{
		executorService.execute(new Runnable() 
		{
			public void run() 
			{
				Log.i("yoyo","FirebaseAppCheck_Init_Extension");
				Log.i("yoyo","YYFirebaseAppCheck Version: " + RunnerJNILib.extGetVersion("YYFirebaseAppCheck"));
				if(RunnerJNILib.extGetVersion("YYFirebaseAppCheck") != "null")
				{
					Log.i("yoyo","Firebase Initialized on FirebaseAppCheck!!!!!!");
