...
function __FirestoreBlob_encode(_inst, _buffer, _offset, _where = _GMFUNCTION_)
{
    ...
    with (_inst)
    {
        ...
        if (!is_string(self.base64)) show_error($"{_where} :: self.base64 expected string", true);
        buffer_write(_buffer, buffer_u32, string_byte_length(self.base64));
        buffer_write(_buffer, buffer_string, self.base64);
...
function __FirestoreBlob_decode(_buffer, _offset)
{
    ...
    with (_inst)
    {
        // field: base64, type: String
        buffer_read(_buffer, buffer_u32);
        self.base64 = buffer_read(_buffer, buffer_string);
...
function firebase_firestore_field_value_blob(_data)
{
    ...
    var __return_value__ = __firebase_firestore_field_value_blob(buffer_get_address(__args_buffer__), buffer_tell(__args_buffer__));
